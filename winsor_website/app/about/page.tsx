...
const teamMembers = [
  {
    ...
    bio: "Shoyeb's strategic vision and operational expertise drive Winsor World Export forward, expanding our global footprint",
  },
  {
    name: "Shafi Kapadiya",
...
const timelineEvents = [
  {
    ...
    description:
      "Brothers Soyeb and Shafi immerse themselves in the vibrant world of seafood, learning the intricacies of the fishing industry.",
    icon: Waves,
    position: "left",
  },
  {
  ...
  },
  {
    ...
    description:
      "Recognizing global opportunities, Soyeb and Shafi establish Winsor World Export, aiming to bring Indian seafood to the world stage.",
    icon: Ship,
    position: "left",
  },
  {
      ...
      <main>
        ...
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 font-sans">Our Story</h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-16 text-center max-w-4xl mx-auto">
              <p className="text-xl text-gray-600 leading-relaxed">
                Today, Winsor World Export stands as a testament to the vision of Soyeb and Shafi Kapadia. Their journey
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center font-sans text-gray-800">
              Our Global Reach
            </h2>
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                >
                  <h3 className="text-2xl font-bold mb-4 text-gray-800 font-sans">Expanding Horizons</h3>
                  <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                    From our roots in Veraval, we've grown to serve customers across the globe. Our commitment to
                    quality and sustainability has allowed us to build strong partnerships in major markets worldwide.
                  </p>
                  <ul className="space-y-4">
                    <li className="flex items-center text-gray-600">
                      <Globe className="w-6 h-6 mr-3 text-blue-500" />
                      <span className="text-lg">Exporting to over 30 countries</span>
                    </li>
                    <li className="flex items-center text-gray-600">
                      <Users className="w-6 h-6 mr-3 text-blue-500" />
                      <span className="text-lg">Serving 200+ international clients</span>
                    </li>
                    <li className="flex items-center text-gray-600">
                      <MapPin className="w-6 h-6 mr-3 text-blue-500" />
                      <span className="text-lg">Strategic partnerships in key markets</span>
                    </li>
                  </ul>
                </motion.div>
              </div>
