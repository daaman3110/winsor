...
const allProducts = [
  {
    ...
    name: "Horse Mackerel",
    category: "Fishes",
    image: "/images/alaska-salmon-hd-8k-wallpaper-stock-photographic-image_890746-60572.avif",
    description: "Premium quality Horse Mackerel, perfect for various culinary applications.",
  ...
  },
  {
    ...
    description: "Fresh Queen Fish with exceptional taste and texture.",
  ...
  },
  {
    ...
    category: "Fishes",
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/yellow.jpg-2wlDquHPLrUwxAearNkwund83dShK6.jpeg",
    packing: "10kgs Packing",
    size: "50gms/100gms, 100gms/200gms, 200gms/300gms, 300gms/up",
  },
  {
                ...
                >
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-6 translate-y-6 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                      ...
                      <p className="text-sm text-gray-200 mb-4 line-clamp-2">{product.description}</p>
                      <Button
                        variant="secondary"
